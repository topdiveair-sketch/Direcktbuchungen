...
{
    public SystemWindow(){InitializeComponent();Loaded+=(_,_)=>DbPathText.Text=App.Database.DatabasePath;}
    ...
    private void Backup_Click(object sender,RoutedEventArgs e)
    {
        ...
        if(dlg.ShowDialog()==true){App.Database.BackupTo(dlg.FileName);StatusText.Text="✓ Backup erstellt.";}
    }
    ...
    private void Export(string fileName,string sql)
    {
        ...
        if(dlg.ShowDialog()==true){App.Database.ExportCsv(sql,dlg.FileName);StatusText.Text="✓ CSV exportiert.";}
    }
