...
async function submitBooking(e){
  ...
  try{
    ...
    saveTripDashboard(refs);setBookingState(`✓ Reiseanfrage ${tripReference||''} übertragen. ${refs.length} Übernachtung${refs.length===1?'':'en'} warten auf Bestätigung. Den Gesamtstatus siehst du unter „Meine Reise“ auf diesem Gerät.`);submit.textContent='Anfrage gesendet ✓';
