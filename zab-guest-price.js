...
async function geo(q){
 ...
 const a=await getJson("https://nominatim.openstreetmap.org/search?format=json&limit=1&countrycodes=at,de,cz,sk,hu&q="+encodeURIComponent(q),{headers:{Accept:"application/json"}});
 if(!a.length) throw Error("Ort oder Unterkunft nicht gefunden.");
